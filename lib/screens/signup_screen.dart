...
class _SignUpScreenState extends State<SignUpScreen>
  ...
  Future<void> _register() async {
    ...
    if (name.isEmpty || email.isEmpty || phone.isEmpty ||
        ...
        selectedRasi == null || selectedNatchatiram == null) {
        ...
        return DropdownMenuItem<String>(
          ...
          child: Row(
            children: [
              ...
              Text(rasi["name"], style: const TextStyle(color: Colors.black)),
            ],
          ),
        );
      }).toList(),
      onChanged: (value) => setState(() => selectedRasi = value),
    );
  }
  ...
  Widget _buildNatchatiramDropdown() {
    return DropdownButtonFormField<String>(
      ...
      items: natchatiramList
          .map((n) => DropdownMenuItem(
              value: n,
              child: Text(n, style: const TextStyle(color: Colors.black))))
          .toList(),
      onChanged: (value) => setState(() => selectedNatchatiram = value),
    );
  }
