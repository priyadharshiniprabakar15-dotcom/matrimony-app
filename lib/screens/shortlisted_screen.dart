        ...
        return Stack(
          children: List.generate(8, (index) {
            ...
            final animationValue =
                (_floatingController.value + index * 0.15) % 1;

            // ✅ SAFE opacity between 0 and 1
            final opacity = (1 - animationValue).clamp(0.0, 1.0);

            return Positioned(
              bottom: animationValue * screenHeight,
              left: left,
              child: Opacity(
                opacity: opacity * 0.6,
                child: Icon(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  ...shortlisted.map((e) => _glassCard(e)).toList(),
